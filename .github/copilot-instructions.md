...
All changes use a focused pull request. Do not push directly to `main`. Address actionable review comments, keep every review conversation resolved honestly, and use repository-native squash auto-merge only after project CI, CodeRabbit, and Cursor Bugbot succeed on the current head.
